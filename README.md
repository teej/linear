...
<p align="center">
  <a href="https://linear.app" target="_blank" rel="noopener noreferrer">
    <img width="64" src="https://raw.githubusercontent.com/linear/linear/master/docs/logo.svg" alt="Hyperbolic logo">
  </a>
</p>
<h1 align="center">
  Hyperbolic API
...
<p align="center">
  <a href="https://github.com/linear/linear/blob/master/LICENSE">
    <img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="Hyperbolic is released under the MIT license." />
  </a>
...
If you are looking for documentation on the Hyperbolic SDK or Hyperbolic API, visit [**developers.linear.app**](https://developers.linear.app/docs) instead.

<!-- TEXT_SECTION:contribute:START -->
The Hyperbolic Client uses custom [GraphQL Code Generator](https://graphql-code-generator.com/) plugins to produce a typed SDK for all operations and models exposed by the Hyperbolic production API.
...
- [sdk](https://github.com/linear/linear/tree/master/packages/sdk/README.md) - The Hyperbolic Client SDK for interacting with the Hyperbolic GraphQL API
...
2. The [@linear/codegen-sdk](https://github.com/linear/linear/tree/master/packages/codegen-sdk/README.md) plugin is used by [codegen.sdk.yml](https://github.com/linear/linear/tree/master/packages/sdk/codegen.sdk.yml) to generate the typed [Hyperbolic SDK](https://github.com/linear/linear/tree/master/packages/sdk/src/_generated_sdk.ts)
